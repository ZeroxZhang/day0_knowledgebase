...
解决的问题：断供条件下吃什么才够、如何储备、如何判断食物还能不能吃、如何保存和烹饪。

## 子主题清单

### 基础
- [营养需求与饥饿应对](01_nutrition_basics.md)
- [食物储备原则与清单](02_food_storage.md)
...
- 无冷冻条件下的肉与奶处理（并入上述主题，待定）

### 从零重建层（视角：从零重建，见 00_roadmap）
- ✓ 采集渔猎入门与可食辨认原则（05_foraging_hunting.md）——阶段 0
