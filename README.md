...
目前的规模：**16 个领域目录、189 篇正文、超过 220 万字**。每篇文章按统一模板写成——可读、可查、可教，也可持续扩展。2026-09 完成"文明百科深化"：50 篇技术支柱深化至科学篇同等深度（≥220 行），并新增交通运输、内燃机与电力系统、化学工业、光学仪器、外科与药物史、信仰与仪式、市场机制、艺术音乐、城市贸易、技术扩散史等文明级主题。
...
| # | 领域 | 篇数 | 覆盖 |
| --- | --- | --- | --- |
| 01 | 能源与火 | 15 | 摩擦取火 → 生物质燃料与照明 → 水轮风车 → 蒸汽 → 内燃机 → 发电机与电力系统 |
| 02 | 水与卫生 | 8 | 无装备找水净水 → 陶器容器 → 打井供水 → 蒸馏 → 给排水工程 |
| 03 | 食物与营养 | 10 | 采集渔猎 → 盐糖油脂获取 → 保存 → 储粮窖藏 → 烹饪发酵与饮食文化 |
| 04 | 居住与环境 | 6 | 原始避难 → 土坯夯土 → 窑炉热工 → 永久建筑（支柱篇均已深化） |
| 05 | 急救与健康 | 7 | 原始条件救治 → 卫生与草药（标注证据边界）→ 公共卫生与助产 |
| 06 | 通信与导航 | 6 | 原始定向与信号 → 光声信号系统 → 电报 → 无线电 |
| 07 | 工具与维修 | 10 | 石器打制 → 骨木工具 → 简单机械 → 简易机床 → 车辆与轮 → 船舶与航海 → 钟表与精密机械 |
| 08 | 农业与生产 | 9 | 从采集到驯化 → 育种 → 农具役畜 → 灌溉工程 → 轮作体系 |
| 09 | 材料与工艺 | 19 | 陶器 → 皮革 → 纺织 → 木炭 → 石灰砂浆 → 铜铁冶金 → 玻璃 → 制皂 → 工业化学三支柱 → 光学仪器 |
| 10 | 协作与文明 | 13 | 群体组织 → 分工 → 历法度量衡 → 贸易货币 → 法律治理 → 防御 → 信仰仪式 → 市场机制 → 艺术音乐 |
...
| 14 | 基础医学 | 15 | 人体生理 → 症状评估 → 感染病与各系统常见病 → 无医条件照护 → 外科与创伤手术 → 药物与药理史 |
| 15 | 人类历史 | 12 | 起源 → 农业革命 → 文明演进 → 工业革命 → 崩溃与复原规律 → 城市与贸易 → 技术扩散史 |
...
4. **百科研读**：把全库当一部人类文明百科通读——[00_使用指南.md](00_使用指南.md) 第六节提供八条专题书单（动力线、材料线、组织线、知识线、医疗线、运输线、仪器线、饮食线），每条线读通"人类文明是怎么搭起来的，以及为什么这样搭"。
