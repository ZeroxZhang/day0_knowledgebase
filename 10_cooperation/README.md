...
解决的问题：小群体如何在资源紧张、秩序缺失时组织起来：分工、分配、决策、处理冲突；以及随着规模扩大，如何建立市场、度量衡、历法、治理等"文明的操作系统"。

## 子主题清单

### 基础（应急视角）
- [小群体组织与分工](01_group_basics.md)
- [资源管理（盘点、分配、消耗控制）](02_resource_management.md)
...
- ✓ [分工专业化](05_specialization_basics.md)：粮食盈余如何催生工匠阶层——阶段 3～5
- ✓ [度量衡制度](06_measure_standards.md)：长度/容积/重量的标准与母器制度——阶段 5
