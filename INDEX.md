...
| 11 基础科学 | [README](11_science/README.md) | 物质与元素、数与算术（根基层）→ 数理（计量/代数/几何/概率）→ 物理（力学/热/流体/声/光/电磁）→ 化学（基础/酸碱盐/氧化燃烧/有机）→ 生命（基础/微生物/植物/动物/生态遗传）→ 天文/天气/地质 → 科学方法（25 篇）→ **大学数学深化：函数与三角、微积分基础、线性代数、正态分布、进制、数论、集合论图论（共 32 篇）** |
...
- 执行规划见项目根目录 `EXECUTION_GUIDE.md`（v2.2）。
